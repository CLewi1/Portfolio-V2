...
export default function Skills() {
    ...
    const handleFlip = (skillName: string) => {
        console.log(`${skillName} Skill Clicked`)
    ...
    return (
        <div className="relative my-6 grid grid-cols-4 gap-2 overflow-hidden bg-background">
            ...
            <button 
                type="button" 
                className={`group relative flex flex-col items-center gap-3 rounded-lg border px-2 py-3 text-center border-neutral-300 dark:border-neutral-800 dark:hover:bg-neutral-900 hover:bg-neutral-100 h-[74px] perspective transition-transform duration-500 transform-style-preserve-3d ${flippedCards['TypeScript'] ? 'rotate-y-180' : ''}`}
            ...
            <button 
                type="button" 
                className={`group relative flex flex-col items-center gap-3 rounded-lg border px-2 py-3 text-center border-neutral-300 dark:border-neutral-800 dark:hover:bg-neutral-900 hover:bg-neutral-100 h-[74px] perspective transition-transform duration-500 transform-style-preserve-3d ${flippedCards['NextJs'] ? 'rotate-y-180' : ''}`}
            ...
            <button 
                type="button" 
                className={`group relative flex flex-col items-center gap-3 rounded-lg border px-2 py-3 text-center border-neutral-300 dark:border-neutral-800 dark:hover:bg-neutral-900 hover:bg-neutral-100 h-[74px] perspective transition-transform duration-500 transform-style-preserve-3d ${flippedCards['TailwindCSS'] ? 'rotate-y-180' : ''}`}
            ...
            <button 
                type="button" 
                className={`group relative flex flex-col items-center gap-3 rounded-lg border px-2 py-3 text-center border-neutral-300 dark:border-neutral-800 dark:hover:bg-neutral-900 hover:bg-neutral-100 h-[74px] perspective transition-transform duration-500 transform-style-preserve-3d ${flippedCards['Swift'] ? 'rotate-y-180' : ''}`}
            ...
            <button 
                type="button" 
                className={`group relative flex flex-col items-center gap-3 rounded-lg border px-2 py-3 text-center border-neutral-300 dark:border-neutral-800 dark:hover:bg-neutral-900 hover:bg-neutral-100 h-[74px] perspective transition-transform duration-500 transform-style-preserve-3d ${flippedCards['Python'] ? 'rotate-y-180' : ''}`}
            ...
            <button 
                type="button" 
                className={`group relative flex flex-col items-center gap-3 rounded-lg border px-2 py-3 text-center border-neutral-300 dark:border-neutral-800 dark:hover:bg-neutral-900 hover:bg-neutral-100 h-[74px] perspective transition-transform duration-500 transform-style-preserve-3d ${flippedCards['Flask'] ? 'rotate-y-180' : ''}`}
            ...
            <button 
                type="button" 
                className={`group relative flex flex-col items-center gap-3 rounded-lg border px-2 py-3 text-center border-neutral-300 dark:border-neutral-800 dark:hover:bg-neutral-900 hover:bg-neutral-100 h-[74px] perspective transition-transform duration-500 transform-style-preserve-3d ${flippedCards['SpringBoot'] ? 'rotate-y-180' : ''}`}
            ...
            <button 
                type="button" 
                className={`group relative flex flex-col items-center gap-3 rounded-lg border px-2 py-3 text-center border-neutral-300 dark:border-neutral-800 dark:hover:bg-neutral-900 hover:bg-neutral-100 h-[74px] perspective transition-transform duration-500 transform-style-preserve-3d ${flippedCards['Java'] ? 'rotate-y-180' : ''}`}
